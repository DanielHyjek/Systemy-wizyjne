%%%%%%%%%%%%%%%%%%%   Binaryzacja lokalna    %%%%%%%%%%%%%%%%%%%%%%
%   Podstawowy algorytm z³o¿ony obliczeniowo i wymaga szukania rozmiaru okna
%sensownego
%   Metoda Sauvol'i to lepsza wesja. Wykorzystuje ona, oprócz œredniej, 
%informacjê o odchyleniu standardowym w danym oknie.
